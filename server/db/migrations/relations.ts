...
import { clients, psiAccounts, wfItem, wfItemStatusHistory, wfStatus, wfItemQueue, summaryProductType, pasHoldings, wfType, psiSubmissions, psiBlotter } from "./schema";
...
export const wfItemStatusHistoryRelations = relations(wfItemStatusHistory, ({one}) => ({
	wfItem: one(wfItem, {
...
export const summaryProductTypeRelations = relations(summaryProductType, ({many}) => ({
...
export const psiSubmissionsRelations = relations(psiSubmissions, ({many}) => ({
